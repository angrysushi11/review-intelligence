# Review Intel Chrome extension privacy

Last updated: 2026-09-25

## Purpose

The Review Intel Chrome extension does one thing: it opens a public App Store or Google Play app listing in hosted Review Intel so the user can choose to retrieve its public reviews.

## What the extension accesses

The extension uses Chrome's `activeTab` permission. It can read the current tab URL only after the user clicks the Review Intel toolbar action.
